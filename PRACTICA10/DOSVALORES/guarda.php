...
<?php
	...
	switch(TRUE){
		...
		case ($n>=1000 && $k>=2 && $k<=10) :
			$div=$n/$k;
			echo '<div class="form-input ap">
					<label for="ap"><i>EL NUMERO </i> '.$n.' ES DIVISIBLE POR '.$k.' UNAS '.$div.' VECES </label>
				</div>';
		break;
		
		case ($n<1000 && ($k<2 || $k> 10)):
			echo '<div class="form-input ap">
					<label for="ap"><i>INSERTA EL VALOR DEL PRIMER NUMERO MAYOR A 1000 Y INSERTA EL VALOR DEL SEGUNDO NUMERO ENTRE 2 Y 10</i></label>
				</div>';
		break;
		...
		case ($n<1000) :
			echo '<div class="form-input ap">
					<label for="ap"><i>INSERTA EL VALOR DEL PRIMER NUMERO MAYOR A 1000</i></label>
				</div>';
		break;
		
		case ($k<2 || $k>10) :
			echo '<div class="form-input ap">
					<label for="ap"><i>INSERTA EL VALOR DEL SEGUNDO NUMERO ENTRE 2 Y 10</i></label>
				</div>';
		break;
	
		default :
			echo '<div class="form-input ap">
					<label for="ap"><i>INSERTA BIEN LOS NUMEROS</i></label>
				</div>';
		break;
