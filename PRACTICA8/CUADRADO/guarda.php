	...
	<body>
		<div class="contenedor">
				<div class="font-titulo">
					<center>CUADRADO DE UN NUMERO</center></div>
					
				<div class="form-input minom">
					<label for="minom"><i>NÚMERO: </i> <?php echo $num;?></label>
				</div>

				<div class="form-input ap">
					<label for="ap"><i>CUADRADO DE DEL NUMERO: </i><?php echo $num;?> ES <?php echo $cua;?></label>
				</div>
