		...
		<div class="contenedor">
			...
			<?php
				...
				if ($discriminante < 0) {
					...
					<label for="minom"><i>El polinomio de segundo grado no tiene raíces reales.</i></label>
				</div>';
				} elseif ($discriminante == 0) {
					$raiz = -$b / (2 * $a);
					echo '<div class="form-input ap">
					<label for="ap"><i>El polinomio tiene una raíz real repetida:  </i>'.$raiz.'</label>
				</div>';
				} else {
					$raiz1 = (-$b + sqrt($discriminante)) / (2 * $a);
					$raiz2 = (-$b - sqrt($discriminante)) / (2 * $a);
					echo '<div class="form-input ap">
					<label for="ap"><i>EL RESULTADO DE LA PRIMERA RAIZ ES  </i>'.$raiz1.'</label>
				</div>';
				echo '<div class="form-input ap">
					<label for="ap"><i>EL RESULTADO DE LA SEGUNDA RAIZ ES   </i>'.$raiz2.'</label>
				</div>';
