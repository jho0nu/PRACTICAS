	...
	<body>
		<div class="contenedor">
				<div class="font-titulo">
					<center>MAYOR DE EDAD</center></div>
<?php

	$num=$_POST['numero1'];
	$lic=$_POST['licencia'];
	switch (TRUE) {
    case (($num>=18)&&($lic=="SI" || $lic=="si")):
        echo '<div class="form-input ap">
					<label for="ap"><i>ERES MAYOR DE EDAD, TIENES </i>'.$num.'<i> AÑOS Y TIENES LICENCIA</i></label>
				</div>';
        break;
    case ($num>=18):
        echo '<div class="form-input ap">
					<label for="ap"><i>TU EDAD ES DE </i>'.$num.'<i> ES DECIR ERES MAYOR DE EDAD</i></label>
				</div>';
        break;
    default:
       echo '<div class="form-input ap">
					<label for="ap"><i>TU EDAD ES DE </i>'.$num.'<i> AÑOS ESTAS CHIQUITO</i></label>
				</div>';
				break;
        break;
}
