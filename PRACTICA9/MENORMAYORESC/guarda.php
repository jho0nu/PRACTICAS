	...
	<body>
		<div class="contenedor">
				<div class="font-titulo">
					<center>MAYOR O MENOR</center></div>
<?php
	...
	switch ($op) {
		...
		case "menor":
			  echo '<div class="form-input ap">
					<label for="ap"><i>DEL MENOR AL MAYOR </i></label>
				</div> <br>';
			if ($num<$num2 && $num2<$num3) {
				echo '<div class="form-input ap">
					<label for="ap"><i>ORDEN </i>'.$num.'-'.$num2.'-'.$num3.'</label>
				</div>';
				echo '<div class="form-input ap">
					<label for="ap"><i>NUMERO MENOR </i>'.$num.'</label>
				</div>';
			} else if ($num<$num3 && $num3<$num2) {
				echo '<div class="form-input ap">
					<label for="ap"><i>ORDEN </i>'.$num.'-'.$num3.'-'.$num2.'</label>
				</div>';
				echo '<div class="form-input ap">
					<label for="ap"><i>NUMERO MENOR </i>'.$num.'</label>
				</div>';
				...
				echo '<div class="form-input ap">
					<label for="ap"><i>ORDEN </i>'.$num2.'-'.$num.'-'.$num3.'</label>
				</div>';
				echo '<div class="form-input ap">
					<label for="ap"><i>NUMERO MENOR </i>'.$num2.'</label>
				</div>';
			} else if ($num2<$num3 && $num3<$num) {
				echo '<div class="form-input ap">
					<label for="ap"><i>ORDEN </i>'.$num2.'-'.$num3.'-'.$num.'</label>
				</div>';
				echo '<div class="form-input ap">
					<label for="ap"><i>NUMERO MENOR </i>'.$num2.'</label>
				</div>'; 
	    		...
	    		echo '<div class="form-input ap">
						<label for="ap"><i>ORDEN </i>'.$num3.'-'.$num.'-'.$num2.'</label>
				</div>';
				echo '<div class="form-input ap">
						<label for="ap"><i>NUMERO MENOR </i>'.$num3.'</label>
				</div>';
			} else {
				echo '<div class="form-input ap">
					<label for="ap"><i>ORDEN </i>'.$num3.'-'.$num2.'-'.$num.'</label>
				</div>';
				echo '<div class="form-input ap">
					<label for="ap"><i>NUMERO MENOR </i>'.$num3.'</label>
				</div>';
		...
		case "mayor":
			echo '<div class="form-input ap">
					<label for="ap"><i>DEL MAYOR AL MENOR </i></label>
				</div> <br>';
			if ($num>$num2 && $num2>$num3) {
				echo '<div class="form-input ap">
					<label for="ap"><i>ORDEN </i>'.$num.'-'.$num2.'-'.$num3.'</label>
				...
				echo '<div class="form-input ap">
					<label for="ap"><i>NUMERO MAYOR </i>'.$num.'</label>
				</div>';
			} else if ($num>$num3 && $num3>$num2) {
				echo '<div class="form-input ap">
					<label for="ap"><i>ORDEN </i>'.$num.'-'.$num3.'-'.$num2.'</label>
				...
				echo '<div class="form-input ap">
					<label for="ap"><i>NUMERO MAYOR </i>'.$num2.'</label>
				</div>';
			} else if ($num2>$num3 && $num3>$num) {
				echo '<div class="form-input ap">
					<label for="ap"><i>ORDEN </i>'.$num2.'-'.$num3.'-'.$num.'</label>
				...
				echo '<div class="form-input ap">
						<label for="ap"><i>NUMERO MAYOR </i>'.$num3.'</label>
				</div>';
			} else {
				echo '<div class="form-input ap">
					<label for="ap"><i>ORDEN </i>'.$num3.'-'.$num2.'-'.$num.'</label>
